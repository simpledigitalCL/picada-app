...
import { type Restaurant, CATEGORY_META, priceLabel } from '@/lib/restaurants'
...
import { MenuCardDetail } from '@/components/menu-card-detail'
import { grantPoints } from '@/lib/gamification'
import { XP_RULES } from '@/lib/engagement-standards'
import { XpChip } from '@/components/xp-chip'
import { useAppStore } from '@/lib/stores/app-store'
import { sharePicada } from '@/lib/share'
...
import { isPlaceSaved, loadCollections, removeFromCollection, updatePlaceNote } from '@/lib/collections'
import { toggleLike, hasLiked, getLikeCount, toggleFollow, isFollowing } from '@/lib/likes'
import { placeTextMatchesLocation } from '@/lib/location-query-match'
import type { SocialPost } from '@/app/api/social-feed/route'
import { triggerSuccessTone, triggerTapHaptic } from '@/lib/device-feedback'
