...
import { ProfileFeedieChrome, type ProfileLens } from '@/components/profile-feedie-chrome'
...
import {
  ...
  savePreferences,
} from '@/lib/reels-personalization'
import {
  loadPoints,
  loadBadges,
  loadStreak,
...
interface ProfileViewProps {
  ...
  onSelectPlace?: (r: import('@/lib/restaurants').Restaurant) => void
}
